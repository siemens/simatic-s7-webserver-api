...
namespace Webserver.API.UnitTests
{
    public class ApiDirectoryBuilderTests : Base
    {
        ...
        {
            var localTmpDirectory = $@"{Environment.CurrentDirectory}\tmp";
        ...
        [OneTimeSetUp]
        public void OneTimeSetup_GetEmptyDirectory()
        {
            TmpDirectory = GetLocalNonexistantTmpDirectory();
            //Directory.CreateDirectory(TmpDirectory);
        }

        [TearDown]
        public void TearDown_DeleteDirectory()
        {
        ...
        public void T001_NonExistantDirectory_ThrowsException()
        {
            ...
            var builder = new ApiDirectoryBuilder(TmpDirectory, new ApiFileResourceBuilder(), false);
        ...
        public void T003_NonExistantConfigFile_ThrowsException()
        {
            ...
            var configFile = Path.Combine(TmpDirectory, "configfile.json");
            var builder = new ApiDirectoryBuilder(TmpDirectory, new ApiFileResourceBuilder(), false);
        ...
        public void T005_DirectoryWithFile_Built()
        {
            ...
            var filePath = Path.Combine(TmpDirectory, "file1.txt");
            ...
            Assert.That(firstRes.PathToLocalDirectory, Is.EqualTo(TmpDirectory));
        }
        ...
        public void T006_DirectoryWithDir_Built()
        {
            ...
            var dirPath = Path.Combine(TmpDirectory, "temp");
        ...
        public void T007_DirectoryWithDirAndFiles_Built()
        {
            ...
            var dirPath2 = Path.Combine(TmpDirectory, "temp");
            ...
            var dirPath3 = Path.Combine(TmpDirectory, "temp", "temp");
