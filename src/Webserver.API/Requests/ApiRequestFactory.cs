...
namespace Siemens.Simatic.S7.Webserver.API.Requests
{
    ...
    {
        private readonly IApiRequestIdGenerator RequestIdGenerator;
        ...
        public ApiRequestFactory(IApiRequestIdGenerator requestGenerator = null)
        {
            RequestIdGenerator = requestGenerator ?? new ApiRequestIdGenerator();
        }
        ...
        public virtual ApiRequest GetApiBrowseRequest(string jsonRpc = null, string id = null)
        {
            ...
            string idReq = id ?? RequestIdGenerator.GetRandomString(8);
